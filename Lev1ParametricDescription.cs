...
class Lev1ParametricDescription : ParametricDescription
{
   ...
   private static long[] toStates0 = new long[] /*2 bits per value */ {
    0x2L
  };
   private static long[] offsetIncrs0 = new long[] /*1 bits per value */ {
    0x0L
  };

   // 2 vectors; 3 states per vector; array length = 6
   private static long[] toStates1 = new long[] /*2 bits per value */ {
    0xa43L
  };
   private static long[] offsetIncrs1 = new long[] /*1 bits per value */ {
    0x38L
  };

   // 4 vectors; 5 states per vector; array length = 20
   private static long[] toStates2 = new long[] /*3 bits per value */ {
    0x69a292450428003L
  };
   private static long[] offsetIncrs2 = new long[] /*2 bits per value */ {
    0x5555588000L
  };

   // 8 vectors; 5 states per vector; array length = 40
   private static long[] toStates3 = new long[] /*3 bits per value */ {
    0x1690a82152018003L,0xb1a2d346448a49L
  };
   private static long[] offsetIncrs3 = new long[] /*2 bits per value */ {
